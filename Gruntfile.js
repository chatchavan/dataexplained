// Generated on 2017-03-01 using generator-angular-fullstack 3.1.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      babel: {
        files: ['<%= yeoman.client %>/{app,components,directives}/**/!(*.spec|*.mock).js'],
      ...
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,components,directives}/**/!(*.spec|*.mock).js',
          '!<%= yeoman.client %>/app/app.js'
        ],
        tasks: ['injector:scripts']
      },
      injectCss: {
        files: ['<%= yeoman.client %>/{app,components,directives}/**/*.css'],
        tasks: ['injector:css']
      },
      mochaTest: {
      ...
      injectLess: {
        files: ['<%= yeoman.client %>/{app,components,directives}/**/*.less'],
        tasks: ['injector:less']
      },
      less: {
        files: ['<%= yeoman.client %>/{app,components,directives}/**/*.less'],
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,components,directives}/**/*.{css,html}',
          '{.tmp,<%= yeoman.client %>}/{app,components,directives}/**/!(*.spec|*.mock).js',
          '<%= yeoman.client %>/assets/images/{,*//*}*.{png,jpg,jpeg,gif,webp,svg,xml,ico,json}'
        ],
        options: {
          livereload: true
        }
    ...
    jshint: {
      ...
      all: ['<%= yeoman.client %>/{app,components,directives}/**/!(*.spec|*.mock).js'],
      test: {
        src: ['<%= yeoman.client %>/{app,components,directives}/**/*.{spec,mock}.js']
      }
    },
    ...
    filerev: {
      dist: {
        src: [
          ...
          '<%= yeoman.dist %>/<%= yeoman.client %>/assets/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg,xml,ico,json}',
    ...
    usemin: {
      ...
      options: {
        ...
        patterns: {
          js: [
            [/(assets\/images\/.*?\.(?:gif|jpeg|jpg|png|webp|svg|xml|ico|json))/gm, 'Update the JS to reference our revved images']
          ]
        }
      }
    },
    ...
    imagemin: {
      dist: {
        files: [{
          ...
          src: '{,*/}*.{png,jpg,jpeg,gif,svg,xml,ico,json}',
    ...
    ngconstant: {
      options: {
        name: 'rationalecapApp.constants',
    ...
    babel: {
      ...
      client: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.client %>',
          src: ['{app,components,directives}/**/!(*.spec).js'],
          dest: '.tmp'
        }]
      },
      server: {
      ...
      scripts: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
               [
                 '.tmp/{app,components,directives}/**/!(*.spec|*.mock).js',
      ...
      less: {
        options: {
          transform: function(filePath) {
            ...
            filePath = filePath.replace('/' + yoClient + '/directives/', '../directives/');
        ...
        files: {
          '<%= yeoman.client %>/app/app.less': [
            '<%= yeoman.client %>/{app,components,directives}/**/*.less',
            '!<%= yeoman.client %>/app/app.less'
          ]
        }
      },
